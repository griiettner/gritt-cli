...
- **Acceptance**: yes, after the five rounds of review fixes recorded in the
  update below.
...
- **Validation**: every check above passed; nothing was skipped except the
  ...
  round 5 are 331 workspace tests over three consecutive runs.
...
- [2026-09-04 review fixes](updates/2026-09-04-review-fixes.md): credential
  ...
  be evicted, and bare-CR SSE framing. Round 5, also appended there: shutdown
  accounting for reservations that have not attached yet, with the launch
  gate that makes that window testable.
